...
client.user.setGame(`LG Communtiy`,"http://twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
client.on('message', message => { 
    ...
    .setFooter(`LG community`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
    ...
    message.channel.send(id)
      ...
      client.on('message', msg => { 
        if (msg.content.startsWith(`$warn`)) {
          ...
          تم اعطائك انذار لفعل غلط لا تكلم الادارة علي الغلط : ${msg.mentions.members.first()}
          لأنك قمت بما يلي
...
message.react("❌")
 ...
 client.on('guildBanAdd', function(guild) {
            const rebellog = client.channels.find("name", "banlog"),
            Onumber = 3,
  Otime = 10000
...
console.log(error)
 ...
 client.on('message', message => {
              if (!message.channel.guild) return;
      if(message.content =='عدد الاعضاء')
